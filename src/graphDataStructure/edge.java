...
public class edge implements edge_data,Serializable{
	...
	/**
	 * @return the temporal data (aka color: e,g, white, gray, black) which can be used by graphAlgorithms.
	 */
	@Override
	public int getTag() {
		return this.tag;
	...
	/** 
	 * Allow setting the "tag" value for temporal marking an edge - common practice for marking by graphAlgorithms.
