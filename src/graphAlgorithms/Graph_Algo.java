...
/**
 * This class represents the set of graph-theory graphAlgorithms
 * @author Meir Nizri, Avihai Bernholtz
 *
 */
public class Graph_Algo implements graph_algorithms, Serializable{

	/** graph-theory graphAlgorithms */
	public graph AlgoG;
	private static final long serialVersionUID = 1L;

	/**
	 * Instantiates a new graph graphAlgorithms.
	 */
	public Graph_Algo() {
		AlgoG = new DGraph();
	}
	...
	/**
	 * Instantiates a new graph graphAlgorithms from graph
	 */
	...
	/* 
	 * Init this set of graphAlgorithms on the parameter - graph.
